  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          ...
          <a class="" href="index.php"><span class="navbar-brand"><span class="glyphicon glyphicon-tree-deciduous"></span> Aircraft</span></a></div>
    ...
    <li><ul class="dashboard-menu nav nav-list collapse">
            ...
            <li ><a href="media.php"><span class="fa fa-caret-right"></span> Media</a></li>
    ...
    <li data-popover="true" data-content="Items in this group require a <strong><a href='http://portnine.com/bootstrap-themes/aircraft' target='blank'>premium license</a><strong>." rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> Premium Features<i class="fa fa-collapse"></i></a></li>
        <li><ul class="premium-menu nav nav-list collapse">
            ...
            <li ><a href="premium-profile.php"><span class="fa fa-caret-right"></span> Enhanced Profile</a></li>
            <li ><a href="premium-blog.php"><span class="fa fa-caret-right"></span> Blog</a></li>
            <li ><a href="premium-blog-item.php"><span class="fa fa-caret-right"></span> Blog Page</a></li>
            <li ><a href="premium-pricing-tables.php"><span class="fa fa-caret-right"></span> Pricing Tables</a></li>
            <li ><a href="premium-upgrade-account.php"><span class="fa fa-caret-right"></span> Upgrade Account</a></li>
            <li ><a href="premium-widgets.php"><span class="fa fa-caret-right"></span> Widgets</a></li>
            <li ><a href="premium-timeline.php"><span class="fa fa-caret-right"></span> Activity Timeline</a></li>
            <li ><a href="premium-users.php"><span class="fa fa-caret-right"></span> Enhanced Users List</a></li>
            <li ><a href="premium-media.php"><span class="fa fa-caret-right"></span> Enhanced Media</a></li>
            <li ><a href="premium-invoice.php"><span class="fa fa-caret-right"></span> Invoice</a></li>
            <li ><a href="premium-build.php"><span class="fa fa-caret-right"></span> Advanced Tools</a></li>
            <li ><a href="premium-colors.php"><span class="fa fa-caret-right"></span> Additional Color Themes</a></li>
    </ul></li>
        ...
        <li><ul class="legal-menu nav nav-list collapse in">
            <li class="active"><a href="privacy-policy.php"><span class="fa fa-caret-right"></span> Privacy Policy</a></li>
