    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		...
		if(isset($_GET['mid']))
		{
			include 'connect.php';
			$mid=$_GET['mid'];
			$sql = "SELECT `mid`,`header`,`msg` FROM message where mid=$mid";
		...
		?>
		<form method="get" action="up_info_message.php">
				<div id='msghere'></div>
				
				<div class="form-group">
				<label>Message id</label>
				<input type="text" value="<?php echo "$mid";?>" name="mid" id="mid" class="form-control" disabled>
				</div>
			   ...
			   <div class="form-group"> 
				...
				<textarea rows="4" cols="50" name="msg" id="msg" class="form-control"><?php echo "$msg";?></textarea>
				</div>
				...
				<script type="text/javascript">
					...
					function SubmitForm(){
						...
						//var tym=$("#tym").val();
						$.ajax({
							url:"up_info_message.php",
							data:{mid:mid,header:header,msg:msg},
							type:"get",
